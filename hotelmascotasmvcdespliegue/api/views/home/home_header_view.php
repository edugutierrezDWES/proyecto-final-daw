            ...
            <div class="row ">
                <div class="col-sm-9 pad0">
                    ...
                    <div class="ipn-title fleft">
                        <h1 clas="ipn-title"><a href="/home/mascotas">Bienvenido, <?php echo $nombre . " " . $apellidos; ?></a></h1>
                    </div>
                </div>
                <!-- dropdown admin -->
                <div class="col-sm-3 text-right"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="true"><?php echo $nombre . " " . $apellidos; ?></a>
                    <ul class="dropdown-menu dropdown-menu-right admin_user" style="margin-top:-30px;" aria-labelledby="dropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="/home/editar"><i class="bi bi-unlock-fill mar_r4"></i>Cambiar Datos</a>
                        <li><a class="dropdown-item" href="/logout"><i class="bi bi-power mar_r4 color_orange"></i>Cerrar Sesión</a></li>
                    </ul>
                </div>
            </div>
        </div>
