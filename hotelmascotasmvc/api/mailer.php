...
<body>
    ...
    ?>
        ...
        try {                  
            ...
            <script type="text/javascript">
                ...
                Swal.fire(
                    ...
                    'success')
                setTimeout(() => {
                    window.location.href = "/hotelmascotasmvc/home/contacto"
                }, 3000);
            </script>
        <?php
        } catch (Exception $e) { ?>
            <script type="text/javascript">
                Swal.fire({
                    ...
                    footer: '<a href="/hotelmascotasmvc/home/contacto">Volver al formulario de contacto</a>'
                })
                setTimeout(() => {
                    window.location.href = "/hotelmascotasmvc/home/contacto"
                }, 5000);
        ...
        } else header("location: /hotelmascotasmvc/home/contacto");
    } else header("location: /hotelmascotasmvc/home/contacto");
