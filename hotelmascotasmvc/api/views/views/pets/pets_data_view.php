            ...
            if (count($mascotas) == 0 || $mascotas === null) { ?>
              ...
              foreach ($mascotas as $mascota) { ?>
                ...
                <tr>
                  ...
                  <td><a href="/hotelmascotasmvc/mascota/form/editar/<?php echo $mascota["id_mascota"]; ?>" class="btn btn_orange bt_login edit">Editar</a>
                    <a id="delete" href="/hotelmascotasmvc/mascota/eliminar/<?php echo $mascota["id_mascota"]; ?>" class="btn btn_red delete">Borrar</a>
                  </td>
                </tr>
            ...
            Swal.fire({
              ...
              if (result.isConfirmed) {
                Swal.fire(
                 ...
                 setTimeout(() => {
                  window.location.href = `/hotelmascotasmvc/mascota/eliminar/${id_mascota}`
                }, 2000); 
            ...
            <?php 
                ...
                foreach ($mascotas as $fila => $mascota) {
                    ...
                    echo "<tr>";
                        ...
                        echo "<td> $tipo </td>";
                        echo "  <td><a href='/hotelmascotasmvc/mascota/form/editar/$id_mascosta' class='btn btn_orange bt_login edit'>Editar</a>
                        <a id='delete' href='/hotelmascotasmvc/mascota/eliminar/$id_mascosta' class='btn btn_red delete'>Borrar</a>
                      </td>";
                    echo "</tr>";
                }
            ?>
